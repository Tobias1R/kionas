...
async fn main() -> Result<(), Box<dyn Error + Send + Sync>> {
    ...
    let worker_info = crate::state::WorkerInformation {
        ...
        server_url: worker_config.server_url.clone(),
        tls_cert_path: worker_config.tls_cert_path.clone(),
        tls_key_path: worker_config.tls_key_path.clone(),
        ca_cert_path: worker_config.ca_cert_path.clone()
    };
