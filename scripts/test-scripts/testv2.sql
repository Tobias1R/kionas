...
join bench4.seed1.products p on p.id = customer_orders.product_id
;
...
from bench4.seed1.customers c
join bench4.seed1.orders o on c.id = o.customer_id
join bench4.seed1.products p on o.product_id = p.id
where o.quantity > 5
...
-- select c.name, p.name as product_name
-- from bench4.seed1.customers c
-- left join bench4.seed1.orders o on c.id = o.customer_id
-- left join bench4.seed1.products p on o.product_id = p.id
-- limit 10;