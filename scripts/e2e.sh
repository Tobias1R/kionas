...
echo "Running E2E tests against Kionas server at $SERVER_ADDR (commit: $LAST_COMMIT_HASH)"
...
echo "[$(date +'%Y-%m-%d %H:%M:%S')][$LAST_COMMIT_HASH] E2E test completed in $ELAPSED_TIME seconds" | tee -a $LOG_EXECUTION_FILE
