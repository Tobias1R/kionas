...
/// A [`Dialect`] for [Kionas](https://www.kionas.com/)
#[derive(Debug, Default)]
pub struct KionasDialect;

impl Dialect for KionasDialect {
    // see https://docs.kionas.com/en/sql-reference/identifiers-syntax.html
